...
//!
//! What the Blob REST API is underneath the Shared Key. Xmip's side writes a
...
//!
//! Chunked transfer encoding is not read. Every answer the Blob service gives to the four
...
mod tests {
    ...
    fn a_request_round_trips_through_its_own_reader() {
        ...
        assert_eq!(read.header_value("host"), Some("blob.local"));
